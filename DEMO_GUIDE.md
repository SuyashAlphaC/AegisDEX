# SocialYield: Demo Video Script & User Testing Guide

## 🎬 Demo Video Script (90 seconds)

### Scene 1: The Problem (0-20s)

**[Visual: Split screen showing Uniswap sandwich attack animation]**

**Narration**:
> "Every day on Ethereum, MEV bots extract over $500 million from regular traders. Sandwich attacks. Frontrunning. It's a tax on retail that goes straight into bot operators' pockets."

**[Visual: Red arrows showing value flowing from users to bots]**

> "What if we could flip this model? Make MEV work for the community, not against it?"

---

### Scene 2: The Solution (20-45s)

**[Visual: SocialYield logo reveal with Initia branding]**

**Narration**:
> "Introducing Social Yield—the first MEV-aware DEX where 100% of captured value goes back to the community."

**[Visual: Landing page scrollthrough]**

> "Built on Initia's interwoven stack, Social Yield uses batch auctions to eliminate frontrunning at the protocol level."

**[Visual: Batch auction animation showing orders collecting and settling at uniform price]**

> "All orders in a window execute at the same price. No bots. No sandwiches. Just fair execution."

---

### Scene 3: The Unique Mechanism (45-65s)

**[Visual: .init name transforming into a yield-generating asset]**

**Narration**:
> "Here's the innovation: we tie MEV rewards to dot-init names. Your Initia identity becomes a productive asset."

**[Visual: Dashboard showing yield accumulating]**

> "Register your dot-init name. Earn passive yield from every trade. No capital required. No impermanent loss. Just pure MEV redistribution."

**[Visual: Quick montage of:]**
- Trade page with order placement
- Batch settling with MEV capture
- Earn page showing rewards claim

---

### Scene 4: The Call to Action (65-90s)

**[Visual: Metrics dashboard]**

**Narration**:
> "Social Yield is live on Initia testnet right now. We've already captured over $10,000 in MEV and redistributed it to our community."

**[Visual: Community leaderboard]**

> "Join the first 1,000 dot-init holders. Shape the future of fair DeFi. Prove that appchains can structurally solve problems that are impossible to fix on monolithic chains."

**[Visual: socialyield.xyz URL with QR code]**

> "Visit socialyield dot x-y-z. Connect your wallet. Start earning today."

**[Final frame: Logo + tagline]**
**"SocialYield: Your MEV, Your Yield."**
...
### Animations:
1. **Sandwich Attack Visualization** (5s loop)
   - Show sandwich bot attack on Uniswap
   - Red warning colors, negative arrows
   - Text: "-2% to MEV" appearing on screen

2. **Batch Auction Mechanism** (10s)
   - Orders flying into a "batch window"
   - Window closes at block 10
   - All orders settle simultaneously
   - Green checkmarks, uniform clearing price

3. **MEV Flow Diagram** (8s)
   - Trading volume → BatchDEX → MEV Capture → Revenue Router → .init Holders
   - 60/30/10 split visualization
   - Coins flowing through the system

4. **Dashboard Walkthrough** (15s)
   - Screen recording of actual testnet app
   - Connect wallet → Place order → See batch status → Claim yield

### B-Roll:
- Initia logo/branding
- Code snippets (smart contracts)
- Terminal showing deployment
- Community Discord screenshots
- Twitter mentions
